    ...
    <>
      ...
      <div data-aos="fade-right"
        ...
        <div className="meta">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://raw.githubusercontent.com/audacity07/travello/master/images/github%20page/pic1.PNG)",
            }}
          ></div>
        </div>
      ...
      <div  data-aos="fade-right"
        ...
        <div className="description">
          ...
          <p className="read-more">
          <a href="https://health-khht942ac-manirhombuz.vercel.app/" target="_blank" >
              <svg
                width="30"
                height="30"
                viewBox="0 0 24 24"
