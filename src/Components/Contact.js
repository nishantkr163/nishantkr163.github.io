                    ...
                    <div className='col-lg-2 d-flex flex-lg-column gap-lg-3 gap-0 social_handles social-links' >
                        <div className="social-links">
                            <div id="twitter" className="social-btn flex-center">
                                ...
                                </svg><span><a href="https://www.facebook.com/nishant.singhii.5" >Facebook</a></span>
                            </div>
                            <div id="linkedin" className="social-btn flex-center">
                                ...
                                </svg><span><a href="https://www.linkedin.com/in/nishant-singh-9629ab270/" >LinkedIn</a></span>
                            </div>
                            <div id="github" className="social-btn flex-center">
                                ...
                                </svg><span><a href="mailto:nishantkr488@gmail.com" >Gmail</a></span>
                            </div>
                            <div id="github" className="social-btn flex-center">
                                <svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                    <g fill="none">
                                ...
                                </svg><span><a href="https://github.com/nishantkr163" >Github</a></span>
                            </div>
                        </div>
                    </div>
