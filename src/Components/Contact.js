      ...
      <div style={{ backgroundColor: "transparent" }} className="container">
        <div className="row d-flex justify-content-around align-items-center">
          <div className="col-lg-5">
            <img
              className="w-lg-100 w-75 contact_image"
              src={contact_image}
              alt="contact_image"
            />
          </div>
          <div className="col-lg-2 d-flex flex-lg-column gap-lg-3 gap-0 social_handles social-links">
            <div className="social-links">
              <div id="twitter" className="social-btn flex-center">
                ...
                <span>
                  <a href="https://www.facebook.com/nishant.singhii.5">
                    Facebook
                  </a>
                </span>
              </div>
              <div id="linkedin" className="social-btn flex-center">
                ...
                >
                  <path
                    fill="black"
                    d="M5 3c0 1.062-.71 1.976-2.001 1.976C1.784 4.976 1 4.114 1 3.052C1 1.962 1.76 1 3 1s1.976.91 2 2zM1 19V6h4v13H1zm6-8.556c0-1.545-.051-2.836-.102-3.951h3.594l.178 1.723h.076c.506-.811 1.746-2 3.822-2C17.1 6.216 19 7.911 19 11.558V19h-4v-6.861c0-1.594-.607-2.81-2-2.81c-1.062 0-1.594.86-1.873 1.569c-.102.254-.127.608-.127.963V19H7v-8.556z"
                  />
                </svg>
                <span>
                  <a href="https://www.linkedin.com/in/nishant-singh-9629ab270/">
                    LinkedIn
                  </a>
                </span>
              </div>
          ...
          <div className="col-lg-5 input_field">
            <form ref={form} onSubmit={sendEmail}>
              ...
              />
              <br />
              <button disabled={send} type="submit" className="send_button">
                SEND
              </button>
            </form>
          </div>
